...
irr::core::dimension2di Race::CalcPlayerMiniMapPosition(Player* whichPlayer) {
    ...
    irr::f32 posPlWidth = miniMapPixelPerCellW * (irr::f32)(whichPlayer->mCurrPosCellX - mMapConfig->minimapCalStartVal.X);
    irr::f32 posPlHeight = miniMapPixelPerCellH * (irr::f32)(whichPlayer->mCurrPosCellY - mMapConfig->minimapCalStartVal.Y);
