...
void Race::InitMiniMapOriginal(irr::u32 levelNr) {
    ...
    CalibrateMiniMap(miniMapStartW, miniMapEndW, miniMapStartH, miniMapEndH);
...
//Helper function to match the original game supplied minimaps (images) to the
//level data files;
void Race::CalibrateMiniMap(irr::u32 &startWP, irr::u32 &endWP, irr::u32 &startHP, irr::u32 &endHP) {
        switch (this->levelNr) {
            case 1: {
                //Lvl 1: StartH = 2, EndH = 125
                //       StartW: 0, EndW = 58
                startHP = 2;
                endHP = 125;
                startWP = 0;
