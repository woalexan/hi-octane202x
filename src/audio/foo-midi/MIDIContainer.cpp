...
//                std::vector<uint8_t> Data(Event.Data.begin() + 2, Event.Data.end());
                ...
                switch (Event.Data[1])
                {
                    case MetaDataTypes::Text:
                    {
                        if (!IsSoftKaraoke)
                        {
                            ...
                            {
                                //
                                snprintf(Name, sizeof(Name), "track_text_%02zd", i);
                        ...
                        else
                        {
                            ...
                            if ((DataSize > 2) && (::strncasecmp((const char *) Event.Data.data() + 2, "@L", 2) == 0))
                            {
                                AssignString((const char *) Event.Data.data() + 4, DataSize - 2, Text);
                            ...
                            if ((DataSize > 2) && (::strncasecmp((const char *) Event.Data.data() + 2, "@T", 2) == 0))
                            {
                                AssignString((const char *) Event.Data.data() + 4, DataSize - 2, Text);
                            ...
                            if ((DataSize > 2) && (::strncasecmp((const char *) Event.Data.data() + 2, "@I", 2) == 0))
                            {
                                AssignString((const char *) Event.Data.data() + 4, DataSize - 2, Text);
                            ...
                            if ((DataSize > 2) && (::strncasecmp((const char *) Event.Data.data() + 2, "@W", 2) == 0))
                            {
                                AssignString((const char *) Event.Data.data() + 4, DataSize - 2, Text);
                    ...
                    {
                        snprintf(Name, sizeof(Name), "track_name_%02u", (unsigned int)i);
                    ...
                    case MetaDataTypes::TimeSignature:
                    {
                        if (DataSize == 4)
                        {
                            snprintf(Name, sizeof(Name), "%d/%d", Event.Data[2], (1 << Event.Data[3]));
            ...
            if (TempTypeName != nullptr)
            {
                if ((TypeName != nullptr) && (::strcasecmp(TypeName, "MT-32") != 0))
                {
                    ...
                    if (((::strcasecmp(TypeName, "GM") == 0) || (::strcasecmp(TypeName, "GM2") == 0)) && (::strcasecmp(TempTypeName, "GS") == 0))
                        TypeName = TempTypeName;
                    else
                    if (::strcasecmp(TempTypeName, "XG") == 0)
                        TypeName = TempTypeName;
                }
                else
                    TypeName = TempTypeName;
...
//                  Event.GetData(Name.data(), 2, Size);
                    ...
                    if ((Size == 7) && (::strncasecmp((const char *) Name.data(), "loopEnd", 7) == 0))
                    {
                        if (!_Loop[SubSongIndex].HasEnd() || (Event.Timestamp > _Loop[SubSongIndex].End()))
