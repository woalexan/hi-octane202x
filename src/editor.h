...
enum
{
    ...
    GUI_ID_TERRAFORMING_WINDOW_BUTTONSELCELLS,
    GUI_ID_TERRAFORMING_WINDOW_BUTTONSELVERTICES,
    GUI_ID_TERRAFORMING_WINDOW_STEPSIZE_COMBOBOX,
    ...
    GUI_ID_REGIONMODEWINDOW_ADDBUTTON,
    GUI_ID_REGIONMODEWINDOW_REMOVEBUTTON,
