...
// This project should be able to compile without freetype (easier when porting to new platforms)
// In case you do not want to use Freetype comment out the define for USE_FREETYPE in definitions.h
#ifdef USE_FREETYPE
